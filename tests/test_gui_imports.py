...
class TestWebGUIImports:
    ...
    def test_gui_module_has_gradio_guard(self):
        ...
        gui_path = Path("src/paper_format_corrector/gui.py")
...
class TestDesktopGUIImports:
    ...
    def test_desktop_gui_module_exists(self):
        from pathlib import Path
        gui_path = Path("src/paper_format_corrector/desktop_gui.py")
    ...
    def test_desktop_gui_imports_safely(self):
        ...
        import paper_format_corrector.desktop_gui as gui_mod
...
class TestApplicationServiceImports:
    ...
    def test_import_style_workbench(self):
        from paper_format_corrector.application.services import style_workbench
    ...
    def test_batch_summary_has_create_zip(self):
        from paper_format_corrector.application.services.batch_service import BatchSummary
    ...
    def test_report_service_has_pdf_export(self):
        from paper_format_corrector.application.services.report_service import ReportService
        rs = ReportService()
...
class TestCoreModuleImports:
    ...
    def test_import_style_extractor(self):
        from paper_format_corrector.core.style_extractor import StyleExtractor
    ...
    def test_import_file_converter(self):
        from paper_format_corrector.core.file_converter import FileConverter
...
class TestInfrastructureImports:
    ...
    def test_import_preset_loader(self):
        from paper_format_corrector.infra.preset_loader import load_preset, list_presets
        assert callable(load_preset)
        assert callable(list_presets)

    def test_import_path_security(self):
        from paper_format_corrector.infra.path_security import validate_input_path, validate_output_path
    ...
    def test_list_presets_returns_multiple(self):
        from paper_format_corrector.infra.preset_loader import list_presets
