...
class TestWebGUIImports:
    ...
    def test_gui_module_has_gradio_guard(self):
        ...
        gui_path = Path("src/paper_format_corrector/api/web/app.py")
...
class TestDesktopGUIImports:
    ...
    def test_desktop_gui_module_exists(self):
        from pathlib import Path
        gui_path = Path("src/paper_format_corrector/api/desktop/app.py")
    ...
    def test_desktop_gui_imports_safely(self):
        ...
        import paper_format_corrector.api.desktop.app as gui_mod
...
class TestApplicationServiceImports:
    ...
    def test_import_batch_service(self):
        from paper_format_corrector.services.batch_service import (
    ...
    def test_import_report_service(self):
        from paper_format_corrector.services.report_service import (
            ReportService,
            ReportData,
        )
    ...
    def test_import_style_workbench(self):
        from paper_format_corrector.services import style_workbench
    ...
    def test_batch_summary_has_create_zip(self):
        from paper_format_corrector.services.batch_service import BatchSummary
    ...
    def test_report_service_has_pdf_export(self):
        from paper_format_corrector.services.report_service import ReportService
        rs = ReportService()
...
class TestCoreModuleImports:
    ...
    def test_import_style_extractor(self):
        from paper_format_corrector.core.correction.extractor import StyleExtractor
...
class TestInfrastructureImports:
    ...
    def test_import_preset_loader(self):
        from paper_format_corrector.adapters.preset_loader import load_preset, list_presets
        assert callable(load_preset)
        assert callable(list_presets)

    def test_import_path_security(self):
        from paper_format_corrector.adapters.path_security import validate_input_path, validate_output_path
    ...
    def test_list_presets_returns_multiple(self):
        from paper_format_corrector.adapters.preset_loader import list_presets
