...
from paper_format_corrector.infra.template_repository import (
    TemplateRepository,
    _parse_version,
    _version_is_newer,
)
from paper_format_corrector.infra.template_sync import TemplateSyncService
...
class TestSeedWithRemote:
    ...
    def test_seed_checks_remote_when_url_provided(self, tmp_path, caplog):
        ...
        manifest = {}
        with patch("paper_format_corrector.infra.template_repository.requests") as mock_requests:
            mock_resp = MagicMock()
