...
def test_section_detector_import():
    from paper_format_corrector.parsers.section_detector import SectionDetector, SectionType, detect_language
...
def test_requirement_parser_import():
    from paper_format_corrector.parsers.requirement_parser import RequirementParser, FONT_SIZE_MAP
...
def test_plugin_manager():
    from paper_format_corrector.infra.plugin_manager import PluginManager, Plugin
...
def test_logger_import():
    from paper_format_corrector.infra.logger import Logger, ProgressBar
