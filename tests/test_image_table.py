...
from paper_format_corrector.core.document.elements.figure_table_handler import FigureTableHandler
...
from paper_format_corrector.core.document.parser.structure import SectionDetector, SectionType
