...
async def generate_correction_plan(
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        try:
            ...
            from ..application.services.style_workbench import plan_to_dict
...
def start_university_import(university: str, requirement_file: str):
    ...
    """
    from ..application.services.university_template_import_service import UniversityTemplateImportService
