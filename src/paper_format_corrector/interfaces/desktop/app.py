...
{json_preview}""")
    ...
    def _validate_template(self):
        ...
        if stored is None:
            ...
            return
        from .application.template_validation import TemplateValidationService
    ...
    def _check_template_updates(self):
        ...
        def do_check():
            try:
                from paper_format_corrector.infrastructure.updater import AutoUpdater, VersionChecker
                repo = self._get_tm_repo()
    ...
    def _build_ai_gen_tab(self, notebook):
        ...
        # 提供商选择
        from paper_format_corrector.infrastructure.llm.provider_config import PROVIDERS
...
7. 生成完成后点击“导出docx”下载"""
    ...
    def _update_provider_combo(self):
        """更新提供商下拉框"""
        from paper_format_corrector.infrastructure.llm.provider_config import PROVIDERS, get_provider_by_name
        provider_names = [p.display_name for p in PROVIDERS.values()]
    ...
    def _on_provider_combo_selected(self, event=None):
        """提供商下拉框选择时的回调"""
        from paper_format_corrector.infrastructure.llm.provider_config import get_provider_by_display
    ...
    def _on_provider_changed(self, *args):
        ...
        from paper_format_corrector.infrastructure.llm.provider_config import get_provider_by_name
    ...
    def _fetch_available_models(self):
        ...
        def do_work():
            try:
                from paper_format_corrector.domain.document.model_discovery import list_models
    ...
    def _test_ai_connection(self):
        ...
        def do_work():
            try:
                from paper_format_corrector.domain.document.model_discovery import probe_model
...
{CONTACT_INFO}"""
    ...
    def _run_batch_correct(self):
        ...
        def do_work():
            try:
                ...
                if tpl:
                    from paper_format_corrector.infrastructure.path_security import validate_input_path
    ...
    def _process_single(self, paper):  # noqa: C901
        """处理单个文件，返回结果文本"""
        from paper_format_corrector.infrastructure.path_security import ALLOWED_INPUT_EXTENSIONS
        from paper_format_corrector.infrastructure.path_security import validate_input_path as _vip
