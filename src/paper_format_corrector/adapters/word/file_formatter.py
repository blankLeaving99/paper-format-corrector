...
from ...core.document.elements.figure_table_handler import FigureTableHandler
from ...core.document.elements.header_footer_handler import HeaderFooterHandler
from ...core.document.elements.image_handler import ImageHandler
from ...core.document.elements.table_handler import TableHandler
from ...core.document.elements.toc_handler import TOCHandler
from ...core.document.cross_reference import CrossReferenceUpdater
from ...core.document.parser.reference import ReferenceFormatter
from ...core.document.parser.section_parser import (
    SectionDetector,
    SectionType,
